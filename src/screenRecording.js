...
function ScreenRecording() {
  const { startRecording, stopRecording, mediaBlobUrl } = useReactMediaRecorder(
    { screen: true, video: true, audio: true }
  );
  return (
    // <ReactMediaRecorder
    //   audio
    ...
    <div>
      ...
      <div className='buttons'>
        <button type='btn' className='btn' onClick={startRecording}>
          Start Recording
        </button>
        <button type='btn' className='btn' onClick={stopRecording}>
          Stop Recording
        </button>
      </div>
      <video src={mediaBlobUrl} autoplay loops controls></video>
    </div>
    //   )}
    // />
  );
